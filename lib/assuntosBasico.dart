...
class AssuntosBasico extends StatelessWidget{
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('FinCalc - Básico', style: Theme.of(context).textTheme.display1.copyWith(color: Colors.white), textScaleFactor: 0.6,),
          actions: <Widget>[
            FlatButton(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            SizedBox(
              ...
              child: Text('Porcentagem', style: Theme.of(context).textTheme.display1.copyWith(color: Colors.white), textScaleFactor: 0.7, ),
